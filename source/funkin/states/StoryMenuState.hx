...
class StoryMenuState extends MusicBeatState
{
	...
	{
		// scoreText.setFormat('VCR OSD Mono', 32);
		lerpScore = Utils.coolLerp(lerpScore, intendedScore, 0.5);
	...
	function selectWeek()
	{
		if (weekUnlocked[curWeek])
		{
			...
			PlayState.SONG = Utils.getSongData(PlayState.storyPlaylist[0].toLowerCase() + diffic, PlayState.storyPlaylist[0].toLowerCase());
